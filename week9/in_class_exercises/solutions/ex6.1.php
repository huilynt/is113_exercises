...
<?php
    if(isset($_POST["tf"])){
       ...
       echo "<th> Index </th> <th> Name </th> <th> Age </th> <th> Gender </th> <th> Rating Score</th> <th> Rated</th>";
       $id = 1;
       foreach($list_pp as $ps){
        echo "<tr>";   
        $rt = $ps->get_rate();
        echo "<td> $id </td> <td> $ps->name </td> <td> $ps->age </td> <td> $ps->gender </td> <td> $ps->rating </td>  <td>  <p style=\"color:#$rt[1];\">$rt[0] </p> </td>";
        echo "</tr>";
        $id++;
       }   
       echo "</table>";
